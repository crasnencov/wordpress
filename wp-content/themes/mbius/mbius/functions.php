...
function mobius_search_form($form) {
	$form = '<div class="sm-title"><h4>Поиск</h4><a href="javascript:void(null)" class="sm-open-close">Close block</a>					</div>
					<div class="sm-block">
	...
	<input type="submit" class="submit" id="searchsubmit" value="'.attribute_escape('Поиск').'" />
	</fieldset>
	</form>';
return $form;
}
